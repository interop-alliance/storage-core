...
Completed items moved verbatim from [ROADMAP.md](ROADMAP.md) as they land,
so SC-N references keep resolving. CHANGELOG.md remains the record of what
shipped.
...
- acceptance:
  - [x] `CollectionDescription` has `plaintext?: { indexes?: ... }` and no
        ...
        (greenfield move)
  - [x] Doc comments: `plaintext` is the counterpart of `encryption` (at
